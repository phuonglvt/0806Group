...
<head>
    ...
    <!-- summernote -->
    <link rel="stylesheet"
        href="<?php echo e(asset('https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/css/bootstrap.min.css')); ?>"
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?php echo e(asset('dist/img/Logo.png')); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">QA Coordinator</span>
    </a>
                <li class="nav-item">
        ...
        <aside class="main-sidebar sidebar-light-yellow elevation-4">
            ...
            <a href="/" class="brand-link">
                <img src="<?php echo e(asset('dist/img/Logo.png')); ?>" alt="AdminLTE Logo" class="brand-image"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">QA Coordinator</span>
            </a>
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('QACo.dashboard')); ?>" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('QACo.dashboard')); ?>" class="nav-link">
          ...
          <li class="nav-item">
          <a href="<?php echo e(route('QACo.sendReport')); ?>" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Report 
              </p>
...
<!-- JQVMap -->
<script src="<?php echo e(asset('plugins/jqvmap/jquery.vmap.min.js')); ?>"></script>
<script src="<?php echo e(asset('plugins/jqvmap/maps/jquery.vmap.usa.j')); ?>"></script>
<!-- jQuery Knob Chart -->
<script src="<?php echo e(asset('plugins/jquery-knob/jquery.knob.min.js')); ?>"></script>
<!-- daterangepicker -->
<script src="<?php echo e(asset('plugins/moment/moment.min.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\devApp\0806Group\project\resources\views/layouts/QACo.blade.php ENDPATH**/ ?>