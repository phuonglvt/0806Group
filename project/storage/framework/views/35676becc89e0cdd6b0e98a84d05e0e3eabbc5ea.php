...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('https://cdn.datatables.net/responsive/2.2.9/js/dataTables.responsive.min.js')); ?>">
        ...
        <aside class="main-sidebar sidebar-light-yellow elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img class="img-account-profile rounded-circle mb-2"
                            ...
                            alt="<?php echo e(asset('public/images/avatar.png')); ?>" loading="lazy">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block"><?php echo e(auth()->user()->name); ?></a>
                        <span>Role: <?php echo e(auth()->user()->role->name); ?></span>
                    </div>
                </div>
                <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <!-- Semester -->
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.semester.index')); ?>" class="nav-link">
                        ...
                        <!-- Mission -->
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.missions.index')); ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.ideas.index')); ?>" class="nav-link">
...
<?php /**PATH C:\xampp\htdocs\devApp\0806Group\project\resources\views/layouts/admin.blade.php ENDPATH**/ ?>