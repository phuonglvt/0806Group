    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">QA Coordinator</span>
        ...
        <aside class="main-sidebar sidebar-light-yellow elevation-4">
          ...
          <li class="nav-item">
            <a href="{{route('QACo.dashboard')}}" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="{{ route('QACo.dashboard')}}" class="nav-link">
          ...
          <li class="nav-item">
          <a href="{{ route('QACo.sendReport')}}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Report 
              </p>
...
<!-- JQVMap -->
<script src="{{ asset('plugins/jqvmap/jquery.vmap.min.js')}}"></script>
<script src="{{ asset('plugins/jqvmap/maps/jquery.vmap.usa.j')}}"></script>
<!-- jQuery Knob Chart -->
<script src="{{ asset('plugins/jquery-knob/jquery.knob.min.js')}}"></script>
<!-- daterangepicker -->
<script src="{{ asset('plugins/moment/moment.min.js')}}"></script>
