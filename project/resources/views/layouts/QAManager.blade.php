<!DOCTYPE html>
<html lang="en">
<<<<<<< HEAD:project/resources/views/layouts/QAManager.blade.php
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">

=======
>>>>>>> origin/admin:project/resources/views/layouts/admin.blade.php
...
<<<<<<< HEAD:project/resources/views/layouts/QAManager.blade.php
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">QA Manager</span>
    </a>
=======
            <!-- Right navbar links -->
